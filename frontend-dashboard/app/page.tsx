      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <Link href="/reports/best-performers">
            ...
            {/* Real vs Projected */}
            <Link href="/reports/real-vs-projected">
              <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow cursor-pointer border-2 border-transparent hover:border-emerald-500">
                <div className="flex items-center mb-4">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900">Real vs Projected</h2>
                </div>
                <p className="text-gray-600">
                  Compare simulated results against actual Alpaca execution to measure slippage
                </p>
