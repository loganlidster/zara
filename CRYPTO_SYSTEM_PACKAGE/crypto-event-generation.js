...
const START_DATE = process.env.START_DATE || '2025-10-26';
...
function generateCombinations() {
  const combinations = [];
  const buyStart = Math.round(0.1 * 10);
...
console.log(`Buy range: 0.1% to ${BUY_MAX}%`);
console.log(`Sell range: ${SELL_MIN}% to ${SELL_MAX}%`);
